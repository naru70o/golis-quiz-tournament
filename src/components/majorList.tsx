        ...
        {majors.map((major) => {
          return (
            <Link
              ...
              className="w-full"
            >
              <div className="flex justify-between items-center px-4 py-2 bg-gray-600 rounded-lg w-full cursor-pointer hover:bg-gray-700 transition-all duration-300 ease-in-out">
